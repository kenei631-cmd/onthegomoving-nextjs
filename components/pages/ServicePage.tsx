...
const SERVICE_DATA: Record<string, {
  ...
  "storage-services": {
    ...
    pricing: [
      { size: "Studio / 1-Bedroom", crew: "1–2 vaults", duration: "Monthly", cost: "$80–$160/mo" },
      { size: "2-Bedroom Home", crew: "2–3 vaults", duration: "Monthly", cost: "$160–$240/mo", highlight: true },
  ...
  "labor-only-moving": {
    ...
    intro: "Need professional muscle without a full-service move? On The Go Moving provides labor-only services for loading, unloading, and moving items within your home — one end or both.",
    whatIsItTitle: "What Is Labor Only Moving?",
    whatIsIt: "Labor only moving services give you professional movers for the specific task you need help with. Whether you're packing up your truck for an out-of-state move, unloading your truck when you arrive in town, moving items from one apartment to another in the same building, or rearranging furniture within your current home — we provide the crew and equipment. You only pay for the labor you actually need.",
    benefits: [
      "Loading your truck before a long-distance or out-of-state move",
      "Unloading your truck when you arrive in the Seattle area",
      "Moving between apartments in the same building",
      "Furniture rearranging and assembly within your home",
      "PODS and portable container loading or unloading",
      "Same professional crews as our full-service moves",
    ],
    whoWeHelp: [
      { icon: Truck, label: "Out-of-State Movers", desc: "Packing up your truck for a long-distance move? We load it right so nothing shifts in transit.", color: "border-brand-green bg-green-50", iconColor: "text-brand-green" },
      { icon: Package, label: "Arriving in Town", desc: "Just pulled in from out of state? We unload your truck and place everything where you want it.", color: "border-blue-400 bg-blue-50", iconColor: "text-blue-500" },
      ...
      { icon: Building2, label: "Furniture Rearrangers", desc: "Need heavy items moved within your current home? We handle it safely.", color: "border-purple-400 bg-purple-50", iconColor: "text-purple-500" },
    ],
    process: [
