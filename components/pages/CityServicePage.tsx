...
function makeLaborOnlyEntry(city: string, citySlug: string): CityServiceData {
  return entry(
    ...
    `On The Go Moving & Storage provides labor-only moving services in ${city}, WA. If you have your own truck or container, our professional movers provide the muscle — loading, unloading, and furniture rearrangement. Many customers find that upgrading to a full-service truck and crew costs only a small amount more per hour and removes all the hassle of renting a truck.`,
    `Our ${city} labor-only crews are the same professional movers who work our full-service moves. Ask us about adding a truck and crew — it's often closer in price than you'd expect, and you skip the rental, the driving, and the liability.`,
    [
